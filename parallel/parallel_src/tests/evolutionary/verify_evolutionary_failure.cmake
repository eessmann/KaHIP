...
if(NOT DEFINED EXPECTED_ABORT_COUNT)
    set(EXPECTED_ABORT_COUNT 2)
endif()
if(NOT abort_count EQUAL EXPECTED_ABORT_COUNT)
    message(
        FATAL_ERROR
        "expected exactly ${EXPECTED_ABORT_COUNT} affected-communicator abort markers; found ${abort_count}\n${probe_output}"
    )
endif()
...
if(diagnostic_offset EQUAL -1)
    message(
        FATAL_ERROR
        "missing evolutionary lifetime failure diagnostic '${EXPECTED_DIAGNOSTIC}'\n${probe_output}"
    )
endif()
