...
TEST_CASE("flattening vector of messages", "[unit][mpi]") {
    SECTION("Empty Vector") {
        ...
        auto [flattened, offsets, lengths] = flatten_messages(m_empty);
    ...
    SECTION("Simple Vector") {
        ...
        auto [flattened, offsets, lengths] = flatten_messages(m_simple);
    ...
    SECTION("Complex Vector") {
        ...
        auto [flattened, offsets, lengths] = flatten_messages(data);
    ...
    SECTION("Sliced Vector") {
        ...
        auto [flattened, offsets, lengths] = flatten_messages(sliced);
